...
def Street(Buyers, Sellers): 
    ...
    while True: # A loop defineing what happens on a given set of days
        ...
        if days == 30: # if 31 days have passed since I last asked this question or since we started...
        ...
        if Sellers == []: # If there are no more sellers...
            q = day # How many days have passed that there was market activity(This does not include today because the stores never opened)
        ...
        if day % 5 == 0: 
            ...
            if chance >= 30:
                Buyers.append(Buyer(str(newBuyer) + "nb", ri(3, 12), ri(3, 12), ri(3, 12), ri(50, 450), ri(150, 550))) # A new buyer is added to the market
                newBuyer += 1
            if chance >= 50:
                Buyers.append(Buyer(str(newBuyer) + "nb", ri(3, 12), ri(3, 12), ri(3, 12), ri(50, 450), ri(150, 550))) # A new buyer is added to the market
                newBuyer += 1
